...
TOOL_DEPS = [
    ...
    wix.artifact(group = "org.apache.maven.resolver", artifact = "maven-resolver-api", version = "1.4.0"),
    wix.artifact(group = "org.apache.maven.resolver", artifact = "maven-resolver-util", version = "1.4.0"),
    wix.artifact(group = "org.apache.maven.resolver", artifact = "maven-resolver-impl", version = "1.4.0"),
    wix.artifact(group = "org.apache.maven.resolver", artifact = "maven-resolver-spi", version = "1.4.0"),
    wix.artifact(group = "org.apache.maven.resolver", artifact = "maven-resolver-transport-http", version = "1.4.0"),
    wix.artifact(group = "org.apache.maven.resolver", artifact = "maven-resolver-transport-file", version = "1.4.0"),
    wix.artifact(group = "org.apache.maven.resolver", artifact = "maven-resolver-connector-basic", version = "1.4.0"),
