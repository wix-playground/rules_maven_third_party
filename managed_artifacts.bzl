...
TOOL_DEPS = [
    ...
    wix.artifact(group = "org.apache.maven", artifact = "maven-artifact", version = "3.8.4"),
    wix.artifact(group = "org.apache.maven", artifact = "maven-model", version = "3.8.4"),
    wix.artifact(group = "org.apache.maven", artifact = "maven-model-builder", version = "3.8.4"),
    wix.artifact(group = "org.apache.maven", artifact = "maven-resolver-provider", version = "3.8.4"),
    wix.artifact(group = "commons-codec", artifact = "commons-codec", version = "1.11"),
    wix.artifact(group = "org.codehaus.mojo", artifact = "mrm-api", version = "1.3.0"),
    wix.artifact(group = "org.codehaus.mojo", artifact = "mrm-maven-plugin", version = "1.3.0", exclusions = [wix.exclusion(artifact = "servlet-api", group = "org.mortbay.jetty")]),
    wix.artifact(group = "org.codehaus.mojo", artifact = "mrm-servlet", version = "1.3.0", exclusions = [wix.exclusion(artifact = "servlet-api", group = "org.mortbay.jetty")]),
